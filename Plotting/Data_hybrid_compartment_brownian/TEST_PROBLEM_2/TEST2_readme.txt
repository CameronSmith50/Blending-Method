TEST 2 - Pure Diffusion left-hand start

Pure diffusion system with a particles uniformly distributed across the left third of the domain, 
i.e. across the pure compartment region.
